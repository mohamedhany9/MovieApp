...
import kotlinx.android.synthetic.main.fragment_latest_movie.view.*
...
class LatestMovieFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_latest_movie, container, false)

        view.recyclerview.layoutManager = GridLayoutManager(context,3)

        val apiService: ApiInterface = ApiClient.getclient().create(ApiInterface::class.java)

        var call: Call<MoviesResponse> = apiService.getLatestMovies(API_KEY)
